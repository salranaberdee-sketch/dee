...
| ดูสถานที่ทั้งหมด | ✅ | ✅ | ✅ |
| ดูปฏิทินสถานที่ | ✅ | ✅ | ✅ |
| สร้างคำขอจอง | ✅ (อนุมัติอัตโนมัติ) | ✅ (อนุมัติอัตโนมัติ) | ✅ (รออนุมัติ) |
| ดูการจองตัวเอง | ✅ | ✅ | ✅ |
| ยกเลิกการจองตัวเอง | ✅ | ✅ | ✅ |
| ดูคำขอจองในชมรม | ✅ | ✅ | ❌ |
| อนุมัติ/ปฏิเสธคำขอ | ✅ | ✅ | ❌ |
...
### หมายเหตุ Auto-Approval
- **Admin/Coach** จองสถานที่ได้ทันที (status = 'approved') โดยไม่ต้องรออนุมัติ
- ระบบจะบันทึก `approved_by` และ `approved_at` อัตโนมัติ (ผู้จองเป็นผู้อนุมัติตัวเอง)
- **Athlete** ต้องรอให้ Coach/Admin อนุมัติก่อน (status = 'pending')
